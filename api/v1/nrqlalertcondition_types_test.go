...
var _ = Describe("NrqlConditionSpec", func() {
	var condition NrqlConditionSpec

	BeforeEach(func() {
		condition = NrqlConditionSpec{
			Terms: []ConditionTerm{
				{
	...
	Describe("ToCondition", func() {
		It("converts NrqlConditionSpec object to NrqlCondition object from go client, retaining field values", func() {
			apiCondition := condition.ToCondition()
