...
var _ = Describe("AlertsNrqlCondition reconciliation", func() {
	var (
		...
		condition      *nralertsv1.AlertsNrqlCondition
	...
	BeforeEach(func() {
		...
		condition = &nralertsv1.AlertsNrqlCondition{
			...
			Spec: nralertsv1.AlertsNrqlConditionSpec{
				Terms: []nralertsv1.AlertsNrqlConditionTerm{
					{
				...
				Nrql: nralertsv1.AlertsNrqlConditionQuery{
			...
			Status: nralertsv1.AlertsNrqlConditionStatus{
				AppliedSpec: &nralertsv1.AlertsNrqlConditionSpec{},
				ConditionID: 0,
			},
		}
		condition = &nralertsv1.AlertsNrqlCondition{
		...
		Context("and given a new AlertsNrqlCondition", func() {
			Context("with a valid condition", func() {
				...
				It("updates the ConditionID on the kubernetes object", func() {
					...
					var endStateCondition nralertsv1.AlertsNrqlCondition
